...
class dialogue:
    ...
    def startGame(self, n):
        ...
        while True:
            ...
            dialogue.window.blit(image_enemy_tank_num, (1170, 100))
            image_enemy_tank_num = pygame.image.load('img/AP_num.gif')
            dialogue.window.blit(image_enemy_tank_num, (1170, 175))
            image_enemy_tank_num = pygame.image.load('img/APCR_num.gif')
            dialogue.window.blit(image_enemy_tank_num, (1170, 250))
            image_enemy_tank_num = pygame.image.load('img/HE_num.gif')
            dialogue.window.blit(image_enemy_tank_num, (1170, 325))
            image_enemy_tank_num = pygame.image.load('img/HEAT_num.gif')
            dialogue.window.blit(image_enemy_tank_num, (1170, 400))
            # 循环遍历墙壁列表，展示墙壁
